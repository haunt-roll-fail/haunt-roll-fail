...
package object elem {
    object styles extends BaseStyleMapping("coup") {
        ...
        object token extends CustomStyle(display("block"), width("2ch"))
        ...
        object card extends CustomStyle(display("block"), width("15ch"))
        
        object kill extends CustomStyle(color("crimson"))
        
        object name extends CustomStyle(font.weight("bold"), padding("0"))

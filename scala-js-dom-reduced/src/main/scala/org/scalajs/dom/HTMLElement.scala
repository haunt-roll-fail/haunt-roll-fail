...
abstract class HTMLElement extends Element {
  var ontouchstart: js.Function1[TouchEvent, _] = js.native
  var ontouchmove: js.Function1[TouchEvent, _] = js.native
  var ontouchend: js.Function1[TouchEvent, _] = js.native

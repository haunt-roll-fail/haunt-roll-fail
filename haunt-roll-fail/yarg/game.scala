...
case class UnitRef(faction : Faction, index : Int) extends Record with GameElementary {
    def elem(implicit game : Game) = game.of(faction).units(index).elem
}
...
class Player(val f : Faction) {
    var units = f.team.indexed./{ (p, n) => new Figure(f, p, n, (f.team.count(p) > 1).?(f.team.take(n).count(p))) }
}
...
trait GameOverBaseInfo extends Info { self : UserAction =>
    def question(implicit g : Game) = "Кінець Гри"
}
    ...
    def performInternal(a : Action) : Continue = {
        ...
        action match {
            ...
            case CaptainHookAction(f, r, t) =>
                ...
                Roll[Int]($(D6), l => CaptainHookRollAction(f, r, t, l.only))
            ...
            case ParrotDistractAction(f, r, t) =>
                ...
                Roll[Int]($(D6), l => ParrotDistractRollAction(f, r, t, l.only))
            ...
            case AttackDamageAction(r, d, then) if r.unit == Parrot && r.stun == 0 =>
                Roll[Int]($(D6), l => ParrotAvoidAttackRollAction(r, d, then, l.only))
            ...
            case PiratePistolAction(f, r, t) =>
                ...
                Roll[Int]($(D6), l => PiratePistolRollAction(f, r, t, l.only))
            ...
            case CabinBoySwordAction(f, r, t) =>
                ...
                Roll[Int]($(D6), l => CabinBoySwordRollAction(f, r, t, l.only))
            ...
            case FireKnightSwordAction(f, r, t) =>
                ...
                Roll[Int]($(D6), l => FireKnightSwordRollAction(f, r, t, l.only))
            ...
            case FireKnightFireballAction(f, r, t) =>
                ...
                Roll[Int]($(D6), l => FireKnightFireballRollAction(f, r, t, l.only))
            ...
            case MageFreezeAction(f, r, t) =>
                ...
                Roll[Int]($(D6), l => MageFreezeRollAction(f, r, t, l.only))
            ...
            case MageRayAction(f, r, t) =>
                ...
                Roll[Int]($(D6), l => MageRayRollAction(f, r, t, l.only))
            ...
            case GameOverAction(winners) =>
                GameOver(winners, "Game Over" ~ Break ~ winners./(f => f.elem ~ " перемогли" ~ Break).join(Break), winners./~(w => $(GameOverWonAction(null, w))))
        }
    }
}